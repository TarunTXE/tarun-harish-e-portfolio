...
export const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: ['Node.js', 'Express.js', 'Django', 'FastAPI', 'fastembed', 'Groq API', 'REST APIs', 'JWT Authentication'],
  },
  {
    id: 'databases',
    ...
    skills: ['MongoDB', 'SQLite', 'MySQL', 'ChromaDB'],
  },
  {
    id: 'tools',
    ...
    skills: ['Git', 'GitHub', 'VS Code', 'Render', 'Vercel', 'Vite', 'Postman'],
  },
];
